<template>
  <a-layout class="layout" :class="[device]">
    <template v-if="layoutMode === 'sidemenu'">
      <a-drawer
        v-if="device === 'mobile'"
        :style="`height: ${hasPermission(permissions.ctiBar) ? fullHeight() - 52 : fullHeight()}px;`"
    ...
    >
      ...
      <!-- layout content -->
      <a-layout-content
        :style="{ paddingTop: fixedHeader ? '59px' : '0', height: `${hasPermission(permissions.ctiBar) ? (fullHeight() - 52) : fullHeight()}px` }"
      >
        <slot></slot>
      </a-layout-content>
    </a-layout>
...
@import '~@assets/sass/_font-size.scss';
@import '~@assets/sass/_spacing.scss';
@import '~@assets/sass/_useful_class.scss';
@import '~@assets/sass/_width_height.scss';
</style>
